...
async def test_get_task_by_id_forbidden(client: AsyncClient, mock_db_session: AsyncMock):
    ...
    app.dependency_overrides[verify_user_ownership] = lambda user_id_param=user_id: other_user_id if user_id_param != other_user_id else user_id_param # Mock ownership check
